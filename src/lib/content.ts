...
export const REALISATIONS: { id: string; src: string; alt: string; title: string; tag: string }[] = [
  ...
  { id: "toiture-nettoyee", src: "/assets/realisations/toiture-tuiles-nettoyee.jpg", title: "Toiture nettoyée", tag: "Nettoyage", alt: "Toiture en tuiles canal nettoyée et démoussée par Artisans de France" },
  { id: "demoussage-2", src: "/assets/realisations/demoussage-toiture-2.jpg", title: "Démoussage de toiture", tag: "Nettoyage", alt: "Démoussage et nettoyage d'une toiture en tuiles par Artisans de France" },
