...
export const SERVICE_META: Record<string, ServiceMeta> = {
  ...
  climatisation: {
    ...
    metier: "climaticien",
    prestations: [
      "Pose de climatisation réversible air/air (mono et multi-split)",
      ...
      "Installation discrète et soignée des unités",
      "Conseils pour un confort d'été maîtrisé",
    ],
    keywords: ["climatisation", "climatisation réversible", "installateur climatisation", "clim air air", "pose climatisation"],
    benefices: [
      "Un confort maîtrisé été comme hiver",
      "Une climatisation réversible économe en énergie",
      "Du matériel dimensionné pièce par pièce",
      "Une installation propre et discrète",
    ],
  },
  peinture: {
    h1Trade: "Peintre",
